...
<%@page import="com.repositoriounia.modelo.Denunciante"%>
<%@page import="com.repositoriounia.dao.DenuncianteDAO"%>
<%@page import="com.repositoriounia.dao.DenuncianteDAOFactory"%>
...
<html>
    ...
    <%
        int idDenunciante = Integer.parseInt(request.getParameter("idDenunciante"));
        DenuncianteDAOFactory fabricate = new DenuncianteDAOFactory();
        DenuncianteDAO daote = fabricate.metodoDAO();
        Denunciante denun=daote.leerxid(idDenunciante);
